...
namespace Bintangku.WebApi.Data.Migrations
{
    ...
    [Migration("20210411055159_UpdateKpspDayaDengar")]
    partial class UpdateKpspDayaDengar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bintangku.WebApi.Data.Entities.DayaDengarDetail", b =>
                {
                    b.Property<int>("DayaDengarDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .UseIdentityByDefaultColumn();
                    ...
                    b.HasKey("DayaDengarDetailId");

                    b.HasIndex("PemeriksaanDayaDengarId");

                    b.ToTable("DayaDengarDetail");
                });
            ...
            modelBuilder.Entity("Bintangku.WebApi.Data.Entities.KpspDetail", b =>
                {
                    ...
                    b.Property<int>("PemeriksaasnKpspId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PemeriksaanKpspId");

                    b.ToTable("KpspDetail");
                });
            ...
            modelBuilder.Entity("Bintangku.WebApi.Data.Entities.DayaDengarDetail", b =>
                {
                    b.HasOne("Bintangku.WebApi.Data.Entities.PemeriksaanDayaDengar", "PemeriksaanDayaDengar")
                        .WithMany("DayaDengarDetails")
                        .HasForeignKey("PemeriksaanDayaDengarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PemeriksaanDayaDengar");
                });
            ...
            modelBuilder.Entity("Bintangku.WebApi.Data.Entities.KpspDetail", b =>
                {
                    b.HasOne("Bintangku.WebApi.Data.Entities.PemeriksaanKpsp", "PemeriksaanKpsp")
                        .WithMany("KpspDetails")
                        .HasForeignKey("PemeriksaanKpspId");

                    b.Navigation("PemeriksaanKpsp");
                });
            ...
            modelBuilder.Entity("Bintangku.WebApi.Data.Entities.PemeriksaanDayaDengar", b =>
                {
                    b.Navigation("DayaDengarDetails");
                });
