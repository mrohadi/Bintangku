...
{
    public partial class RefactorDatabse : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TanggalLahirAnak = table.Column<DateTime>(type: "TEXT", nullable: false),
                    PhotoAnakUrl = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KesehatanAnaks", x => x.Id);
                    table.ForeignKey(
